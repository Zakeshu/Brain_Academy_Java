package com.brainacad.module_2.LabWork_2_10;

/**
 * Created by a.zemlyanskiy on 05.09.2016.
 * Open project MyShapes (from 2.8 labs).
 * Rewrite the Rectangle class to add new public static method called parseRectangle (String) which returns new object as Rectangle type based on string passed as argument.
 ...
 * Rewrite the Shape.parseShape(String) method in Shape class to use invocation of particular parse…() method for each shape object type (in switch statement).
 * For example:
 * Rectangle.parseRectangle (String) method to parse string in case of Rectangle object.
 * Execute program.
 */
public class Lab_Work_2_10_4 {
}
