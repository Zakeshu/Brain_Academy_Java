 ...
 * Add code to main() method in class Main which read integer value as string line from console (using Scanner class) and then convert it to value of integer type (using Integer.parseInt() method). Use this integer value as array length to initialize new array of shapes.
