 ...
 * Create a generic class MyTestMethod with static method “calcNum” (with two parameters: an array T[] and variable maxelm of type T) that counts the number of elements in an array T[] that are greater than a specified element maxelm.
